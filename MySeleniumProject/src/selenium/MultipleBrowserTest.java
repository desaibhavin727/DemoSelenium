...
public class MultipleBrowserTest {
	...
	public static void main(String[] args) {
		...
		Xls_Reader P = new Xls_Reader("/Volumes/personal data/NIKUL QA/Selenium_WorkSpace/MySeleniumProject01/NikulTest.xlsx");

		String p = P.getCellData("Data1", "Browser", 2);
